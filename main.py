...
class ApplicationWindow(QtWidgets.QMainWindow):
    ...
    def map_range(self,input_value):
        output_value = input_value * (255 / 2500)   # 2500 is the max value of the property and 255 is the max pixel value
        return output_value
    ...
    def t1(self, in_image):
        ...
        values = [self.map_range(500), self.map_range(800), self.map_range(250), self.map_range(3000)]
    ...
    def t2(self, in_image):
        ...
        values = [self.map_range(80), self.map_range(100), self.map_range(55), self.map_range(2000)]
    ...
    def SD(self, in_image):
        ...
        values = [self.map_range(0.1), self.map_range(0.2), self.map_range(0.5), self.map_range(0.7)]
