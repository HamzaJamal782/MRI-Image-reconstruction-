...
class ApplicationWindow(QtWidgets.QMainWindow):
    def __init__(self):
        ...
        self.ui.pushButton_Run_Generat_phantom.clicked.connect(self.popUpErrorMsg)
    ...
    def browse(self):
        try:
            ...
            self.rgbImage = self.rgbImage.scaled(512,512)
...
# function to choose size of image from combobox_size
    ...
    def getPixel(self, event):
        ...
        self.orgImg = qimage2ndarray.rgb_view(self.rgbImage) # convert qimage to numpy arrays
